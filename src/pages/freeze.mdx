...
![Freeze scheduled timeline events](freeze-timeline-schedule-events.png) {{ className: 'mid' }}
...
When a freeze starts, the member’s door access will be automatically suspended for the duration of the freeze. Any payments that were scheduled during the freeze are removed. The next payment will be scheduled on the freeze end date.

![Freeze started timeline events](timeline-freeze-started.png) {{ className: 'lrg'}}
...
![Freeze details modal](freeze-details-modal.png) {{className: 'modal'}}
